 ...
 * representation. The iteration steps through all possible unit value levels, regardless of whether there were
 * recorded values for that value level or not, and terminates when all recorded histogram values are exhausted.
 */
